...
vim.api.nvim_set_hl(0, "VertSplit", { fg = "#252525", bg = "#1E1E1E" })
vim.api.nvim_set_hl(0, "LspSagaDiagnosticBorder", { fg = "#D4D4D4", bg = "#1E1E1E" })
vim.api.nvim_set_hl(0, "LspSagaDiagnosticTruncateLine", { fg = "#D4D4D4", bg = "#1E1E1E" })
vim.api.nvim_set_hl(0, "FocusedSymbol", { fg = "#1E1E1E", bg = "#FFEB3B" })
